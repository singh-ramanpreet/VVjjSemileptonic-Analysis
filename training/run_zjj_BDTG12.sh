...
gridSearch=0
version_out="zjj_BDTG12"
mkdir -p ${version_out}
./train_BDTG.py \
  --in-files "root://cmseos.fnal.gov//eos/uscms/store/user/rsingh/wv_vbs_ntuples/training_input/2021_Apr_27/*.root" \
  ...
  --boson Z \
  --ttree "Events" \
  --vars "lep2_eta,vbf_m,dibos_m,zeppLep_deta,ht_resolved,vbf1_AK4_qgid,vbf2_AK4_qgid" \
